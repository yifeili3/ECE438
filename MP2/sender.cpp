...
int num_pkt_sent = 0, num_pkt_received = 0, num_pkt_total = 0;
...
int fillingWindow(FILE *fp, int pkt_num) {
    int counter = 0;
    char file_buffer[MSS];
    packet pkt;
    while (!file_read_finished && counter < pkt_num) {
